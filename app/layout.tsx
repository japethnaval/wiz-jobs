...
/** Below-the-fold band: load in a separate chunk so GSAP (typing subtitle) is not on the critical path. */
...
/** Only register weights used in the UI (body 300, Tailwind 400–900; italics only for 500/800). Drops thin + unused italics to cut mobile network cost. */
