...
export function GlassFeatureCard({ icon, title, children, className }: GlassFeatureCardProps) {
  return (
    <article
      className={[
        "flex w-full min-h-0 flex-col gap-4 rounded-[16px] border border-white/55 bg-white/72 p-6 shadow-[0_8px_32px_rgba(15,23,42,0.08)] backdrop-blur-md sm:gap-5 sm:p-8 lg:max-w-[409px] lg:mx-auto",
        className,
      ]
        .filter(Boolean)
        .join(" ")}
