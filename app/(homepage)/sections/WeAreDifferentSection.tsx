...
function WMark() {
  return (
    <div
      ...
      aria-hidden
    >
      <WizLogo className="absolute left-0 top-1/2 h-[4.5rem] w-auto min-w-[11rem] -translate-y-1/2 text-blue-600 sm:h-[5rem]" />
    </div>
  );
}
...
export function WeAreDifferentSection() {
  return (
      <section aria-labelledby="we-are-different-heading">
        <div className="mx-auto w-full max-w-[min(100%,56rem)] px-4 sm:px-6">
          <FadeInScale>
            <div className="rounded-[1.75rem] border-[3px] border-cyan-400 px-4 py-8 shadow-sm sm:rounded-[2rem] sm:border-4 sm:px-8 sm:py-8 lg:px-8 lg:py-12">
              <FadeUp>
                <h2
              ...
              >
                <span className="block">Why We’re Different</span>
                <span className="mt-1 block text-lg font-semibold text-neutral-700 sm:text-xl lg:text-2xl">
              ...
              <table className="w-full min-w-[36rem] table-fixed border-separate border-spacing-0 text-sm sm:min-w-0 sm:text-base">
                ...
                <colgroup>
                  <col className="w-1/3" />
                  <col className="w-1/3" />
                  <col className="w-1/3 bg-[linear-gradient(0deg,#DAE0FC_33%,rgba(218,224,252,0.72)_77%,rgba(255,255,255,0)_100%)]" />
                </colgroup>
                <thead>
                  <tr>
                    <th
                      scope="col"
                      className="w-1/3 px-4 pb-4 text-center text-[0.9375rem] font-semibold text-blue-600"
                    >
                      Feature
                    </th>
                    <th
                  ...
                  {rows.map((row, index) => {
                    ...
                    return (
                      <tr key={row.feature}>
                        <td
                          className={
                            "px-4 py-4 text-center align-middle font-medium text-blue-700"
                          }
                        >
                          {row.feature}
                        </td>
                        <td
                          className={
                            "px-4 py-4 text-center align-middle text-blue-600"
                          }
                        >
                          {row.traditional}
                        </td>
                        <td
                          className={[
                            "px-4 py-4 text-center align-middle text-base font-bold italic text-blue-700",
