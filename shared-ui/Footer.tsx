...
import { Icon5, Icon29 } from "@/assets";
...
const resourceLinks = [{ label: "Help Center", href: "/coming-soon" }] as const;
...
const socials = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/wizjobsofficial/",
    icon: (
  ...
  {
    name: "X",
    href: "https://x.com/WizJobsOfficial",
    icon: (
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/company/wizjobsofficial",
    icon: (
          ...
          <div className="order-2 flex flex-col gap-6 lg:order-3 lg:col-span-3 lg:items-end">
            <div className="flex flex-wrap gap-3 lg:justify-end">
              {socials.map((item) => {
                ...
                const AssetIcon =
                  "assetIcon" in item ? item.assetIcon : undefined;
                return (
                <Link
                  key={name}
                  href={href}
                  ...
                  aria-label={opensInNewTab ? `${name} (opens in new tab)` : name}
                  {...(opensInNewTab
