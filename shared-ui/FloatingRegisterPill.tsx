...
export function FloatingRegisterPill({
  ...
  return (
    <div className={["fixed right-[-24px] top-1/3 z-50 -translate-y-1/2 sm:right-[-44px]", className].filter(Boolean).join(" ")}>
      <Link
        href={href}
        className="group flex h-[48px] w-[100px] origin-right flex-col items-center justify-center rounded-full border-2 border-[#1e2533] bg-white text-center shadow-[0_8px_24px_rgba(0,0,0,0.12)] transition duration-300 ease-out motion-safe:hover:-rotate-6 hover:bg-[#455ef6] sm:h-[80px] sm:w-[182px]"
        {...rest}
      >
